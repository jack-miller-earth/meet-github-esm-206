...
.tabset means anything that starts w header the next level down, will make a new tab on your output document
Anything with 4 # will be a new tab

#### Ringtail cat

![Ringtail cat (courtest of VA Zoo)](img/ringtail_cat.jpg)
...
###
The 3 # mean that anything beyond this is outside of the tab section 
